...
- [x] `emb secrets list` shows all secret references in config
- [x] `emb secrets validate` verifies all secrets are accessible
- [x] `emb secrets providers` shows provider connection status
- [x] Clear error messages for common issues (permission denied, not found, etc.)
- [x] JSON output option for CI/CD integration
- [x] Unit tests for discovery and validation logic
